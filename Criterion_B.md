...
| 15.         	| Create new dish Page                	| Create a create new dish page where only admin can have access to. Create a form that requires input of dish name, category, meal time, picture and any comments. Data will be stored in a user database after the validation of inputs such as image type.                                                        	| 150                 	| May 19                 	| C         	|
| 16.         	| Menu Page                           	| Create a menu page that students can have access to. Displays today's dish details, name, category, meal time and image, retrieving dish name, category and image link. Allows users to input whether they are attending to the meal, inserting them into the data table.                                          	| 100                 	| May 19                 	| C         	|
| 17.         	|                                     	|                                                                                                                                                                                                                                                                                                                    	|                     	|                        	|           	|
|             	|                                     	|                                                                                                                                                                                                                                                                                                                    	|                     	|                        	|           	|
|             	|                                     	|                                                                                                                                                                                                                                                                                                                    	|                     	|                        	|           	|
|             	|                                     	|                                                                                                                                                                                                                                                                                                                    	|                     	|                        	|           	|
